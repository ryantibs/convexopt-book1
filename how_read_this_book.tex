...
\SkipTocEntry\section*{Background and recommendations}

% asterisks mark sections (typically more advanced) that can be skipped without
% interrupting the flow of main ideas  

% some chapters are more statistics-focused than others. we have tried
% throughout to hit statistical / ML examples as the focus, but balanced by
% other common more generic examples of interest.

% what to cover in what order, e.g., in a PhD course. 

\SkipTocEntry\section*{Notation and conventions}
...
% if statements are vacuous when conditions are vacuous, then ... so be it.
