...
seminal work on the topic in the early-mid 1960s, including
\cite{moreau1962fonctions, moreau1963inf, moreau1963proprietes,
  moreau1965proximite}. Moreau studied the ways in which proximal operators 
generalize projections, and developed (what is now called) the Moreau
envelope. Some authors refer to this as Moreau-Yosida regularization, to
recognize earlier related work in functional analysis by Kosaku Yosida
\cite{yosida1948differentiability}. To learn more about proximal maps and the
history behind them, we refer to \cite{rockafellar2009variational} (Chapters
1.G, 2.D, 3.D). See also the more recent monograph \cite{parikh2013proximal},
which gives numerous interesting interpretations and examples. The connection
between the proximal operator and the resolvent of the subdifferential is due to
\cite{rockafellar1976monotone}. For an elegant treatment of this and related
topics from the perspective of monotone operators, we refer to
