...
\eqref{eq:lasso_dual} (which is unique because the dual criterion is strictly 
...
smoothness. For any two response vectors $y, y' \in \R^n$ and the
corresponding lasso fitted vectors \smash{$X \hbeta(y), X \hbeta(y') \in \R^n$},
we have           
\begin{equation}
