...
\title{Convex Optimization for Statistics and Machine Learning, 
  Part I: Analysis}
...
% Note: * means it can be skipped without interrupting the flow of main ideas 

\part{Introduction}
\include{why_read_this_book}
\include{how_read_this_book}
%\include{} % what about deep learning/modern MLopt?
%\include{} % how to read this book
...
\include{duality_linear}
\include{duality_general}
\include{kkt}
\include{dual_correspondences}

\part{Advanced Topics}

% Uniqueness without strict convexity
\include{caratheodory_theorems}
% Parametric convex programming?
% Infinite-dimensional optimization?

\appendix
\include{app_basic_topology}
