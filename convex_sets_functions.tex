...
\item \label{ex:face_structure} 
  ...
  $M_i = \boundary(H_i)$ (a hyperplane), for $i=1,\dots,m$. We assume that this  
  representation is \emph{irredundant}: this means removing any of the
  halfspaces from the intersection gives rise to a different polyhedron. 

% For example, Theorems 2-6 in Chapter 2.6 of Grunbaum (2003)
\begin{enumerate}[label=\alph*.]
\item Prove that each $F_i = M_i \cap P$ is a facet of $P$ (face of dimension
  $d-1$), for $i=1,\dots,m$. 
