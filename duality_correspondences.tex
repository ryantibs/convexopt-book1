...
\end{equation}
Note that for a polyhedron $P$, its polar set is just another term for its dual
polyhedron in \eqref{eq:dual_polyhedron}, $P^\circ = P^*$. Meanwhile, for a cone
$K$, its is polar set is the negative dual cone in \eqref{eq:dual_polyhedron},
