...
nicely by the quadratic function $f(x) = \frac{1}{2} x^\T Q x$, where $Q \succ
0$, and $f^*(u) = \frac{1}{2} u^\T Q^{-1}u$. Denote by
...
conjugates and proximal operators under left scaling (Exercise
...
\smash{$g = \frac{1}{2\lambda} \|\cdot\|_2^2$}. Applying the last fact thus
gives
\[
...
$f_\lambda$ is too (it is in fact differentiable, hence continuous), so we can
take the conjugate of both sides above and apply
...
f$). This fact can indeed by rigorously verified; see Exercise 
