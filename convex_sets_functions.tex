...
\item For convex $f$, prove the final part of Theorem
  ...
  argument here and that used to prove that the conjugate of a strongly
  convex function is Lipschitz smooth; see Exercise
  \ref{ex:conjugate_smoothness} parts a and b. % The last display above is
  % equivalent to the conclusion that the conjugate $f^*$ of $f$ is strongly
  % convex with parameter $1/L$. To check this, set $u = \nabla f(x)$, $v =
