...
See Theorem 3.2.2 in Ben Tal and Nemirovski. This is more general but it will be
helpful to write this as: min $c^\T x$ subject to $Gx \leq h$, $Ax + b \in K$,
where $K$ is pointed etc.
