...
problem 
\[
\minimize_x \quad \frac{1}{10} x^4 - 5x^2 + 10x \quad \st \quad x \geq -5.
\]
The left panel of Figure \ref{fig:} plots its criterion, a nonconvex quartic
function. The dual function $g$ associated with this problem can be calculated  
explicitly, because it requires .... and ... a cubic polynomial has closed-form solutions for its roots. 
\end{Example}
