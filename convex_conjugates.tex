...
\smash{$g = \frac{1}{2\lambda} \|\cdot\|_2^2$}, that is, \smash{$f_\lambda = f
  \infconv \frac{1}{2\lambda} \|\cdot\|_2^2$}. Applying the fact from Property
\parref{par:conjugate_general_sum} thus gives
\[
...
$f_\lambda$ is too (recall, it is differentiable, hence continuous), so we can
