...
\item For logistic regression, where \smash{$\Psi(\eta) = \sum_{i=1}^n
  ...
  $\|\cdot\|$-norm. Then argue that \eqref{eq:slater_dual_glm} holds as long as
...
% Derive conjugate of sum of indicators?
% Derive dual in terms of gauge of polar set? 
% Exercise on plurality of dual problems?
