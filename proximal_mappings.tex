...
% Proposition 4.2 in Bauschke and Combettes (2011) 
...
\item Use the above pair of inequalities to prove that 
  ...
  \big( x - p_x - (y - p_y) \big)^\T (p_x - p_y) \geq 0, \quad \text{for all
    $x,y$}. 
  \]
  Hint: expand $y - p_x = y - p_y + p_y - p_x$ in the first inequality, $x - p_y
  = x - p_x + p_x - p_y$ in the second inequality, then subtract the two and
  simplify.   
