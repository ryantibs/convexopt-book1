...
\setcounter{page}{7} % Change page number to 7 if a dedication is present
...
% - Polyhedra: https://arxiv.org/pdf/2410.03014

% Log-concave dist? MAYBE if I can find a way to learn+cover this well.
% Optimal transport? MAYBE if I can find a way to learn+cover this well.
% Proper losses? MAYBE
% Monotone operators? Not sure ... it's been covered abundantly elsewhere. 
...
% - Berge maximum theorem or other classic thm?
