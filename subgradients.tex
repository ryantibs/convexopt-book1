...
(and convexity of the sublevel set) to argue that the interiors of the
conic hulls of category-$d$ subdifferentials along a level set form a
collection of disjoint open sets in $\R^d$, hence by classical arguments in
