...
which is given in Corollary \ref{cor:slater_sdp}. Exercise 
\ref{ex:convex_theorem_alternatives} is based on the theorem of alternatives
from \cite{bental2023convex}.         
...
\item \label{ex:convex_theorem_alternatives}
  Let $f$ and $h_i$, $i=1,\dots,m$ be convex, and $\ell_j$, $j=1,\dots,k$ be
  affine. Following Theorem 3.2.1 in \cite{bental2023convex}, consider the
